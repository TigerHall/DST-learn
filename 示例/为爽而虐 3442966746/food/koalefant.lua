...
AddBrainPostInit("koalefantbrain",
                 function(self) if self.bt.root.children then table.insert(self.bt.root.children, 3, Follow(self.inst, koalefantGetLeader, 4, 24, 8)) end end)
...
AddBrainPostInit("spatbrain",
                 function(self) if self.bt.root.children then table.insert(self.bt.root.children, 5, Follow(self.inst, spatGetLeader, 8, 24, 12)) end end)
