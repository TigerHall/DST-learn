...
local DoraemonClickInventory = Class(function(self, inst)
    self.inst = inst
    self.type = nil
    self._ischarged = net_bool(inst.GUID, "doraemon_click_inventory._ischarged")
...
function DoraemonClickInventory:GetType()
    if self.type then
