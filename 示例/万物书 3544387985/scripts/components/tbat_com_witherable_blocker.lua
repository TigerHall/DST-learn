...
----------------------------------------------------------------------------------------------------------------------------------
local tbat_com_witherable_blocker = Class(function(self, inst)
    inst:AddTag("tbat_com_witherable_blocker")
    self.inst = inst
...
------------------------------------------------------------------------------------------------------------------------------
---
    function tbat_com_witherable_blocker:SetRadius(radius)
        self.radius_sq = radius * radius
    end
------------------------------------------------------------------------------------------------------------------------------
---
    function tbat_com_witherable_blocker:IsInBlockingArea(target_or_pt)
        local pt = nil
...
------------------------------------------------------------------------------------------------------------------------------
return tbat_com_witherable_blocker
