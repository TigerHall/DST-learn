...
AddPrefabPostInit(
    ...
    function(inst)
        ...
        --     if target and target:HasTag("tbat_com_skins") then
        --         return true
        --     else
        ...
        --     if target and target.components.tbat_com_skins and doer and doer.components.tbat_com_skins then
        --         doer.components.tbat_com_skins:SetNextSkin(target)
        --     else
        --         return self:CastSpell__fwd_in_pdt_old(target, pos, doer)
        --     end
        -- end
        
        inst:AddComponent("tbat_com_skin_tool")
