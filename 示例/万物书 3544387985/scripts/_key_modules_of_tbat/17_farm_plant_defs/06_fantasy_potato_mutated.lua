...
PLANT_DEFS["tbat_farm_plant_fantasy_potato_mutated"]	= {
	build = "tbat_farm_plant_fantasy_potato_mutated", 			--这是作物的动画文件，也就是你需要改的地方
	bank = "tbat_farm_plant_fantasy_potato_mutated",				--这是bank文件，直接用土豆的就行
	--生长时间
	...
	--农作物代码
	prefab = "tbat_farm_plant_fantasy_potato_mutated",			--记得改
	--果实
	product = "tbat_food_fantasy_potato",				--记得改
	--巨型果实
	product_oversized = "tbat_eq_fantasy_potato_mutated_oversized",		--记得改
	--种子
	seed = "tbat_food_fantasy_potato_mutated_seed",				--记得改
	--作物标签
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 
	AddPrefabPostInit("tbat_farm_plant_fantasy_potato_mutated",function(inst)
