...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/tbat_turf_fake_ocean_shallow.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/tbat_turf_fake_ocean_shallow.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/tbat_turf_fake_ocean_shallow.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/tbat_turf_fake_ocean_shallow.tex" ),
        Asset( "IMAGE", "levels/textures/tbat_turf_fake_ocean_shallow_mini.tex" ),
    -- 地皮边缘遮罩
...
local turf_name = "tbat_turf_fake_ocean_shallow"
...
AddTile(
    ...
    {                                                            --- ground_tile_def    应该是游戏场景内地皮相关的参数
        name="cave",                                                  --- 地毯遮罩类型   resolvefilepath("levels/tiles/"..trimmed_name, true)
...
ChangeTileRenderOrder(WORLD_TILES[string.upper(turf_name)], WORLD_TILES.SHELLBEACH)
