...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/tbat_turf_fallen_cherry_blossoms.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/tbat_turf_fallen_cherry_blossoms.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/tbat_turf_fallen_cherry_blossoms.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/tbat_turf_fallen_cherry_blossoms.tex" ),
        Asset( "IMAGE", "levels/textures/tbat_turf_fallen_cherry_blossoms_mini.tex" ),
    -- 地皮边缘遮罩
...
local turf_name = "tbat_turf_fallen_cherry_blossoms"
...
ChangeTileRenderOrder(WORLD_TILES[string.upper(turf_name)], WORLD_TILES[string.upper("tbat_turf_lavender_dusk")]) -- 优先级低于 耕地
