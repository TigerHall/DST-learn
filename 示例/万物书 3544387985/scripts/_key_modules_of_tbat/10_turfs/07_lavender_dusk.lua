...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/tbat_turf_lavender_dusk.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/tbat_turf_lavender_dusk.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/tbat_turf_lavender_dusk.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/tbat_turf_lavender_dusk.tex" ),
        Asset( "IMAGE", "levels/textures/tbat_turf_lavender_dusk_mini.tex" ),
    -- 地皮边缘遮罩
...
local turf_name = "tbat_turf_lavender_dusk"
...
ChangeTileRenderOrder(WORLD_TILES[string.upper(turf_name)], WORLD_TILES[string.upper("tbat_turf_clover_butterfly")]) -- 优先级低于 耕地
