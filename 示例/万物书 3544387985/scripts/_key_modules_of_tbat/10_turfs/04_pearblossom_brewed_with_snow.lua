...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/tbat_turf_pearblossom_brewed_with_snow.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/tbat_turf_pearblossom_brewed_with_snow.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/tbat_turf_pearblossom_brewed_with_snow.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/tbat_turf_pearblossom_brewed_with_snow.tex" ),
        Asset( "IMAGE", "levels/textures/tbat_turf_pearblossom_brewed_with_snow_mini.tex" ),
    -- 地皮边缘遮罩
        Asset( "IMAGE", "levels/tiles/tbat_jungle.tex" ),
        Asset( "IMAGE", "levels/tiles/tbat_jungle.tex" ),
...
local turf_name = "tbat_turf_pearblossom_brewed_with_snow"
...
AddTile(
    ...
    {                                                            --- ground_tile_def    应该是游戏场景内地皮相关的参数
        name="tbat_jungle",                                                  --- 地毯遮罩类型   resolvefilepath("levels/tiles/"..trimmed_name, true)
    ...
    {                                                            --- turf_def    自动生成prefab 用的参数 turfs.lua 里调取用的
        ...
        anim = "idle",                                         --- PlayAnimation 使用，通常为 idle
        bank_build = turf_name,                              --- bank build 同名字的时候用这个参数
...
ChangeTileRenderOrder(WORLD_TILES[string.upper(turf_name)], WORLD_TILES[string.upper("tbat_turf_fallen_cherry_blossoms")]) -- 优先级低于 耕地
