...
local temp_assets = {
    -- 被挖起来的地皮物品动画
        Asset("ANIM", "anim/tbat_turf_checkerfloor_pink.zip"), 
    -- 物品栏贴图
        Asset( "IMAGE", "images/inventoryimages/tbat_turf_checkerfloor_pink.tex" ),  -- 背包贴图
        Asset( "ATLAS", "images/inventoryimages/tbat_turf_checkerfloor_pink.xml" ),
    -- 地皮贴图
        Asset( "IMAGE", "levels/textures/tbat_turf_checkerfloor_pink.tex" ),
        Asset( "IMAGE", "levels/textures/tbat_turf_checkerfloor_pink_mini.tex" ),
    -- 地皮边缘遮罩
...
local turf_name = "tbat_turf_checkerfloor_pink"
