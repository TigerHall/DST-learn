...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_plant_fluorescent_mushroom"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_plant_fluorescent_mushroom.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 
    local type_num = 1
...
--- 植物本体
    local function plant_fn()
        ...
        inst.AnimState:SetBank("tbat_plant_fluorescent_mushroom")
        inst.AnimState:SetBuild("tbat_plant_fluorescent_mushroom")
...
--- 创建物品
    local function item_fn()
        ...
        --- 图标和检查
            ...
            inst.components.inventoryitem:TBATInit("tbat_plant_fluorescent_mushroom_item","images/inventoryimages/tbat_plant_fluorescent_mushroom_item.xml")
        ------------------------------------------------------------------------------------------
        --- 叠堆
