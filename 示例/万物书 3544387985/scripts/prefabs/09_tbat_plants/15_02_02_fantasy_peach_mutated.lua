...
-- 最终打包
    ...
    local assets =
    {
        Asset("ANIM", "anim/tbat_farm_plant_fantasy_peach_mutated.zip"),
        Asset("ANIM", "anim/tbat_farm_plant_fantasy_peach.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 参数
    local this_plant_name = "tbat_farm_plant_fantasy_peach_mutated"             --- 农作物名字（prefab)
    local oversized_item_prefab = "tbat_eq_fantasy_peach_mutated_oversized"     --- 采集后的巨大作物prefab
...
--- 种子物品
    ...
    --     inst.AnimState:SetBank("tbat_farm_plant_fantasy_peach_mutated")
    --     inst.AnimState:SetBuild("tbat_farm_plant_fantasy_peach_mutated")
    --     inst.AnimState:PlayAnimation("idle")
    ...
    --         -- inst.components.inventoryitem:TBATInit("tbat_farm_plant_fantasy_peach_mutated","images/inventoryimages/tbat_farm_plant_fantasy_peach_mutated.xml")
    ...
    --     return inst
    -- end
    -- AddIngredientValues({"tbat_food_fantasy_peach_mutated_seed"}, {seed=1})  --- 种子进入烹饪锅
    -- table.insert(ret_prefabs,Prefab("tbat_food_fantasy_peach_mutated_seed", fn_seeds, assets))
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 巨型采摘后的作物
    ...
    local function oversized_onequip(inst, owner)  -- 玩家搬动巨大作物物品
        owner.AnimState:OverrideSymbol("swap_body", "tbat_farm_plant_fantasy_peach_mutated", "swap_body")
    end
    ...
    local oversized_loots = {
        ...
        "tbat_food_fantasy_peach","tbat_food_fantasy_peach",
    }
    local function oversized_makeloots(inst)  --- 掉落物生成
        ...
        if math.random() <= 0.03 then
            table.insert(ret_loots, "tbat_plant_mutated_fantasy_peach_seed")
        end
        return ret_loots
    end
    ...
    local function fn_oversized()
        ...
        --- 检查和物品
            ...
            inst.components.inventoryitem:TBATInit("tbat_eq_fantasy_peach_mutated_oversized","images/inventoryimages/tbat_eq_fantasy_peach_mutated_oversized.xml")
        -----------------------------------------------------------
        --- 穿戴（背负）
...
--- 打蜡后的物品
    ...
    local function fn_oversized_waxed()
        ...
        inst:AddTag("heavy")
        -- inst:AddTag("tbat_eq_fantasy_peach_mutated_oversized_waxed")
