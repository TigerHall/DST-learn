...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_plant_kitty_bush"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_plant_kitty_bush.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 皮肤API套件
    local building_skin_data = {}
    for i = 2, 12, 1 do
        building_skin_data["tbat_plant_kitty_bush_"..i] = {
            bank = "tbat_plant_kitty_bush",
            build = "tbat_plant_kitty_bush",
            atlas = "images/inventoryimages/tbat_plant_kitty_bush_"..i..".xml",
            image = "tbat_plant_kitty_bush_"..i,  -- 不需要 .tex
    ...
    for i = 2, 12, 1 do
        TBAT.SKIN:AddForDefaultUnlock("tbat_plant_kitty_bush_"..i)        
    end
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- workable
    local workable_cmd = {
...
--- 创建物品
    local function building()
        ...
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_plant_kitty_bush","tbat_plant_kitty_bush")
        inst.AnimState:PlayAnimation("idle1",true)
