...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_plant_mutated_fantasy_peach"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_plant_mutated_fantasy_peach.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---
    local GROW_DATA = {
        [1] = {     -- sprout  发芽
            index = "sprout",
            loot = {{"tbat_plant_mutated_fantasy_peach_seed"}},
        ...
        [4] = {     -- full  结果
            index = "full",
            loot = {{"tbat_food_fantasy_peach",6},{"smallmeat",2}},
            time = TBAT.DEBUGGING and (TUNING.TOTAL_DAY_TIME - 10) or 3*TUNING.TOTAL_DAY_TIME,
            picked_fn = function(inst, picker, loot)
                inst.components.growable:SetStage(2)
                inst.components.growable:StartGrowing()
            end,
            ex_loot = {{"tbat_plant_mutated_fantasy_peach_seed"}},
        },
    }
    --- 转置一下
    local GROW_DATA_IDX = {}
...
--- 创建物品
    local function plant_fn()
        ...
        inst.AnimState:SetBank("tbat_plant_mutated_fantasy_peach")
        inst.AnimState:SetBuild("tbat_plant_mutated_fantasy_peach")
        inst.AnimState:PlayAnimation("stage_4_idle",true)
        inst:AddTag("plant")
...
--- seed
    ...
    local function seed_fn()
        ...
        ---
            ...
            inst.components.inventoryitem:TBATInit("tbat_plant_mutated_fantasy_peach_seed","images/inventoryimages/tbat_plant_mutated_fantasy_peach_seed.xml")
            MakeHauntableLaunch(inst)
        -----------------------------------------
        ---
