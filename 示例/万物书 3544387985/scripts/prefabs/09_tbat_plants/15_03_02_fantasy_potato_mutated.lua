...
-- 最终打包
    ...
    local assets =
    {
        Asset("ANIM", "anim/tbat_farm_plant_fantasy_potato_mutated.zip"),
        Asset("ANIM", "anim/tbat_farm_plant_fantasy_potato.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 参数
    local this_plant_name = "tbat_farm_plant_fantasy_potato_mutated"             --- 农作物名字（prefab)
    local oversized_item_prefab = "tbat_eq_fantasy_potato_mutated_oversized"     --- 采集后的巨大作物prefab
...
--- 种子物品
    ...
    --     inst.AnimState:SetBank("tbat_farm_plant_fantasy_potato_mutated")
    --     inst.AnimState:SetBuild("tbat_farm_plant_fantasy_potato_mutated")
    --     inst.AnimState:PlayAnimation("idle")
	...
	-- 	inst.plant_def = PLANT_DEFS[this_plant_name]
    ...
    --         -- inst.components.inventoryitem:TBATInit("tbat_farm_plant_fantasy_potato_mutated","images/inventoryimages/tbat_farm_plant_fantasy_potato_mutated.xml")
    --         inst.components.inventoryitem:TBATInit("tbat_food_fantasy_potato_seeds","images/inventoryimages/tbat_food_fantasy_potato_seeds.xml")
    --     -----------------------------------------------------------
    --     --- 腐烂
    ...
    --     return inst
    -- end
    -- AddIngredientValues({"tbat_food_fantasy_potato_mutated_seed"}, {seed=1})  --- 种子进入烹饪锅
    -- table.insert(ret_prefabs,Prefab("tbat_food_fantasy_potato_mutated_seed", fn_seeds, assets))
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 巨型采摘后的作物
    ...
    local function oversized_onequip(inst, owner)  -- 玩家搬动巨大作物物品
        owner.AnimState:OverrideSymbol("swap_body", "tbat_farm_plant_fantasy_potato_mutated", "swap_body")
    end
    ...
    local oversized_loots = {
        ...
        "tbat_food_fantasy_potato_seeds","tbat_food_fantasy_potato_seeds",
        "tbat_food_fantasy_potato","tbat_food_fantasy_potato","tbat_food_fantasy_potato","tbat_food_fantasy_potato",
        "tbat_food_fantasy_potato","tbat_food_fantasy_potato",
    }
    local function oversized_makeloots(inst)  --- 掉落物生成
        local ret_loots = {}
        for k, v in pairs(oversized_loots) do
            table.insert(ret_loots, v)
        end
        if math.random() <= 0.03 then
            table.insert(ret_loots, "tbat_plant_mutated_fantasy_potato_seed")
        end
        return ret_loots
    end
    ...
    local function fn_oversized()
        ...
        --- 检查和物品
            ...
            inst.components.inventoryitem:TBATInit("tbat_eq_fantasy_potato_mutated_oversized","images/inventoryimages/tbat_eq_fantasy_potato_mutated_oversized.xml")
        -----------------------------------------------------------
        --- 穿戴（背负）
...
--- 打蜡后的物品
    ...
    local function fn_oversized_waxed()
        ...
        inst:AddTag("heavy")
        -- inst:AddTag("tbat_eq_fantasy_potato_mutated_oversized_waxed")
