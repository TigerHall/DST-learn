...
-- 最终打包
    ...
    local assets =
    {
        Asset("ANIM", "anim/tbat_food_fantasy_potato_seed.zip"),
        Asset("ANIM", "anim/tbat_farm_plant_fantasy_potato.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 参数
    local this_plant_name = "tbat_farm_plant_fantasy_potato"             --- 农作物名字（prefab)
    local oversized_item_prefab = "tbat_eq_fantasy_potato_oversized"     --- 采集后的巨大作物prefab
...
--- 种子物品
    ...
    local function fn_seeds()
        ...
        inst.AnimState:SetBank("tbat_food_fantasy_potato_seed")
        inst.AnimState:SetBuild("tbat_food_fantasy_potato_seed")
        inst.AnimState:PlayAnimation("idle")
		...
		inst.plant_def = PLANT_DEFS["tbat_farm_plant_fantasy_potato"]
        ...
        --- 直接烤
            ...
            inst.components.cookable.product = "tbat_food_fantasy_potato_seeds_cooked"
        -----------------------------------------------------------
        --- 诱饵
    ...
    AddIngredientValues({"tbat_food_fantasy_potato_seeds"}, {seed=1})  --- 种子进入烹饪锅
    table.insert(ret_prefabs,Prefab("tbat_food_fantasy_potato_seeds", fn_seeds, assets))
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 巨型采摘后的作物
    ...
    local function oversized_onequip(inst, owner)  -- 玩家搬动巨大作物物品
        owner.AnimState:OverrideSymbol("swap_body", "tbat_farm_plant_fantasy_potato", "swap_body")
    end
    ...
    local function fn_oversized()
        ...
        --- 检查和物品
            ...
            inst.components.inventoryitem:TBATInit("tbat_eq_fantasy_potato_oversized","images/inventoryimages/tbat_eq_fantasy_potato_oversized.xml")
        -----------------------------------------------------------
        --- 穿戴（背负）
...
--- 打蜡后的物品
    ...
    local function fn_oversized_waxed()
        ...
        inst:AddTag("heavy")
        -- inst:AddTag("tbat_eq_fantasy_potato_oversized_waxed")
