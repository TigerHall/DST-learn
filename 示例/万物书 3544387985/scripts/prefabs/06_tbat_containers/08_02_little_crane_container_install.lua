...
---
    ...
    ----- 检查和注册新的容器界面
        ...
        all_container_widgets.MAXITEMSLOTS = math.max(all_container_widgets.MAXITEMSLOTS, 64)
        ...
        if params[container_widget_name] == nil then
            ...
            ------------------------------------------------------------------------------------------
            --- 左上角是格子1
                local single_slot_bg = { image = "tbat_container_little_crane_bird_slot.tex", atlas = "images/widgets/tbat_container_little_crane_bird_slot.xml" }
                for i = 1, 64, 1 do
            ...
            ---- item test
                widget_data.itemtestfn =  function(container_com, item, slot)
                    return item:HasTag("tbat_tag.erasablepaper")
                end
