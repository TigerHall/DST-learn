...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_resource_river_pebble"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_resource_river_pebble.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 皮肤API套件
    ...
    for i = 2, 6, 1 do
        building_skin_data["tbat_resource_river_pebble_"..i] = {
            bank = "tbat_resource_river_pebble",
            build = "tbat_resource_river_pebble",
            atlas = "images/inventoryimages/tbat_resource_river_pebble_"..i..".xml",
            image = "tbat_resource_river_pebble_"..i,  -- 不需要 .tex
        ...
        item_skin_data["tbat_resource_river_pebble_item_"..i] = {
            bank = "tbat_resource_river_pebble",
            build = "tbat_resource_river_pebble",
            atlas = "images/inventoryimages/tbat_resource_river_pebble_"..i..".xml",
            image = "tbat_resource_river_pebble_"..i,
            ...
            placed_skin_name = "tbat_resource_river_pebble_"..i,
            skin_link = "tbat_resource_river_pebble_"..i,
        }
    end
    TBAT.SKIN:DATA_INIT(building_skin_data,this_prefab)
    TBAT.SKIN:DATA_INIT(item_skin_data,this_prefab.."_item")
    for i = 2, 6, 1 do
        -- TBAT.SKIN:AddForDefaultUnlock("tbat_resource_river_pebble_"..i)
        TBAT.SKIN:AddForDefaultUnlock("tbat_resource_river_pebble_item_"..i)
    end
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- workable
    local workable_cmd = {
...
--- 创建物品
    local function building()
        ...
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_resource_river_pebble","tbat_resource_river_pebble")
        inst.AnimState:PlayAnimation("idle1",true)
...
--- 物品
    ...
    local function item_fn()
        ...
        --- 
            ...
            inst.components.inventoryitem:TBATInit("tbat_resource_river_pebble","images/inventoryimages/tbat_resource_river_pebble.xml")
        --------------------------------------------------------------------
        ---
