...
local prefabs_name_list = {
    ...
    "01_river_pebble",      --  河石
    "02_kitty_stone",      --  花喵小石子

    "03_01_memory_crystal_ore_fx",      --  记忆水晶矿源FX
    "03_02_memory_crystal_ore_1",       --  记忆水晶矿源(1级)
    "03_03_memory_crystal_ore_2",       --  记忆水晶矿源(2级)
    "03_04_memory_crystal_ore_3",       --  记忆水晶矿源(3级)
    "03_05_memory_crystal_ore_core",    --  记忆水晶矿心
}
