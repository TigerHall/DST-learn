...
local file_folders = {
    "_debugging_prefabs",       -- 正在开发调试的总集合。变动频繁
    "00_tbat_others",           -- 其他无法归类的
    "01_tbat_items",            -- 物品/道具
    "02_tbat_materials",        -- 单纯的材料
    "03_tbat_equipments",       -- 可穿戴的装备
    "04_tbat_foods",            -- 可以吃的食物 / 或者种子
    "05_tbat_foods_cooked",     -- 烹饪出来的食物 / 或者种子
    "06_tbat_containers",       -- 带容器的东西（装备/建筑 等）
    "07_tbat_buildings",        -- 建筑
    "08_tbat_resources",        -- 无法归类的自然资源
    "09_tbat_plants",           -- 植物 + 种子
    "10_tbat_minerals",         -- 矿物
    "11_tbat_animals",          -- 各类动物/生物
    "12_tbat_boss",             -- BOSS
    "13_tbat_pets",             -- 宠物
    "14_tbat_turfs",            -- 地皮
    "15_tbat_debuffs",          -- Debuffs
    "16_tbat_spells",           -- 技能（一般用于制作栏）
    "17_tbat_sfx",               -- 特效 FX
    "18_tbat_projectiles",      -- 弹药
    "19_tbat_characters",       -- 角色
    "20_tbat_events",           -- 事件、资源刷新器等
    "21_tbat_rooms",            -- 房间/岛屿 创建相关资源
    "22_tbat_npc",              -- NPC


    "tbat_prefabs_mz",          -- mz负责的预制物
...
local function Load_lua_file_2_prefabs_table(tempAddr)
    ...
    local function self_load_file_to_prefabs_by_pcall(pcall_retFlag,...)
        ...
        if pcall_retFlag == true then
            ...
            TBAT.__load_prefabs_error = true
