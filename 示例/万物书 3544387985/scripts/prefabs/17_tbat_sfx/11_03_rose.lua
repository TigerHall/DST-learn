local TEXTURE = resolvefilepath("images/tbat_effect_fx/tbat_sfx_rose.tex")

local SHADER = "shaders/vfx_particle.ksh"

local COLOUR_ENVELOPE_NAME = "tbat_sfx_rose_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_rose_scaleenvelope"
...
return Prefab("tbat_sfx_rose", fn, assets)
