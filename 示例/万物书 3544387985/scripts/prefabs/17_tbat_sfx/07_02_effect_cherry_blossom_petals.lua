...
local TEXTURE = resolvefilepath("images/tbat_effect_fx/cherry_blossom_petals.tex")
--------------------------------------------------------------------------
...
local COLOUR_ENVELOPE_NAME = "tbat_sfx_effect_cherry_blossom_petals_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_effect_cherry_blossom_petals_scaleenvelope"
...
return Prefab("tbat_sfx_effect_cherry_blossom_petals", fn, assets)
