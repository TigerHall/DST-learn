local TEXTURE = resolvefilepath("images/tbat_effect_fx/tbat_sfx_baton_bunny_scepter.tex")
--- 1024x128 - 8格
--------------------------------------------------------------------------
...
local COLOUR_ENVELOPE_NAME = "tbat_sfx_baton_bunny_scepter_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_baton_bunny_scepter_scaleenvelope"
...
return Prefab("tbat_sfx_baton_bunny_scepter", fn, assets)
