...
local TEXTURE = resolvefilepath("images/tbat_effect_fx/cherry_blossom.tex")
--------------------------------------------------------------------------
...
local COLOUR_ENVELOPE_NAME = "tbat_sfx_effect_cherry_blossom_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_effect_cherry_blossom_scaleenvelope"
...
return Prefab("tbat_sfx_effect_cherry_blossom", fn, assets)
