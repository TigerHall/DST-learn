local TEXTURE = resolvefilepath("images/tbat_effect_fx/tbat_sfx_yellow_star.tex")

local SHADER = "shaders/vfx_particle.ksh"

local COLOUR_ENVELOPE_NAME = "tbat_sfx_yellow_star_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_yellow_star_scaleenvelope"
...
return Prefab("tbat_sfx_yellow_star", fn, assets)
