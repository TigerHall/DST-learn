local TEXTURE = resolvefilepath("images/tbat_effect_fx/tbat_sfx_blue_flower.tex")

local SHADER = "shaders/vfx_particle.ksh"

local COLOUR_ENVELOPE_NAME = "tbat_sfx_blue_flower_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_blue_flower_scaleenvelope"
...
return Prefab("tbat_sfx_blue_flower", fn, assets)
