...
local TEXTURE = resolvefilepath("images/tbat_effect_fx/butterfly.tex")
--------------------------------------------------------------------------
...
local COLOUR_ENVELOPE_NAME = "tbat_sfx_effect_butterfly_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_effect_butterfly_scaleenvelope"
...
return Prefab("tbat_sfx_effect_butterfly", fn, assets)
