...
local function fx()
    ...
    inst.AnimState:SetBank("archive_lockbox_player_fx")
    inst.AnimState:SetBuild("archive_lockbox_player_fx")
    inst.AnimState:PlayAnimation("activation", false)
...
return Prefab("tbat_sfx_knowledge_flash",fx,assets)