local TEXTURE = resolvefilepath("images/tbat_effect_fx/tbat_sfx_cheese_heart_phantom_butterfly_dining_fork.tex")
--- 1024x128 - 8格
--------------------------------------------------------------------------
...
local COLOUR_ENVELOPE_NAME = "tbat_sfx_cheese_heart_phantom_butterfly_dining_fork_colourenvelope"
local SCALE_ENVELOPE_NAME = "tbat_sfx_cheese_heart_phantom_butterfly_dining_fork_scaleenvelope"
...
return Prefab("tbat_sfx_cheese_heart_phantom_butterfly_dining_fork", fn, assets)
