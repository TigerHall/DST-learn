...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_food_fantasy_peach"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_food_fantasy_peach.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 
    local foods_data = {
        ...
        [this_prefab.."_cooked"] ={
            ...
            image = "tbat_food_fantasy_peach_cooked",
        },
...
--- 创建物品
    ...
    for temp_prefab, data in pairs(foods_data) do
            ...
            local function fn()
                ...
                inst.AnimState:SetBank("tbat_food_fantasy_peach")
                inst.AnimState:SetBuild("tbat_food_fantasy_peach")
                inst.AnimState:PlayAnimation(data.anim.normal)
                inst:AddTag("cattoy")
