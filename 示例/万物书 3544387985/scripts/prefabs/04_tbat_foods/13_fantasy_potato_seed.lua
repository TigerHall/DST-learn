...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_food_fantasy_potato_seeds"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
...
--- 
    local foods_data = {
        [this_prefab] ={
            ...
            image = "tbat_food_fantasy_potato_seeds",
        ...
        [this_prefab.."_cooked"] ={
            ...
            image = "tbat_food_fantasy_potato_seeds_cooked",
        },
    ...
    for temp_prefab, data in pairs(foods_data) do
            ...
            local function fn()
                ...
                --- 腐烂
                    ...
                    inst.components.perishable:SetPerishTime(TBAT.PARAM.ONE_DAY*40)
                -----------------------------------------------------------
                --- 可叠堆
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 添加到烹饪锅
    AddIngredientValues({this_prefab,this_prefab.."_cooked"}, {seed=1})
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
