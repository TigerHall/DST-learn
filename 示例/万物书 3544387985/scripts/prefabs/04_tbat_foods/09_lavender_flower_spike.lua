...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_food_lavender_flower_spike"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_food_lavender_flower_spike.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 
...
--- 创建物品
    local function fn()
        ...
        inst.AnimState:SetBank("tbat_food_lavender_flower_spike")
        inst.AnimState:SetBuild("tbat_food_lavender_flower_spike")
        inst.AnimState:PlayAnimation("item")
        ...
        -----------------------------------------------------------
            ...
            inst.components.inventoryitem:TBATInit("tbat_food_lavender_flower_spike","images/inventoryimages/tbat_food_lavender_flower_spike.xml")
        -----------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 添加到烹饪锅
    AddIngredientValues({this_prefab}, {veggie=1})
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
