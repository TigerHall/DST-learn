...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_item_veil_of_knowledge_potion"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_item_veil_of_knowledge_potion.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- workable 右键使用模块
    local function workable_on_work_fn(inst,doer)
        ...
        ------------------------------------------------------------------------------------------
        --- 创建特效
            local fx = doer:SpawnChild("tbat_sfx_blue_flower")
...
--- 创建物品
    local function item_fn()
        ...
        inst.AnimState:SetBank("tbat_item_veil_of_knowledge_potion")
        inst.AnimState:SetBuild("tbat_item_veil_of_knowledge_potion")
        ...
        --- 图标和检查
            ...
            inst.components.inventoryitem:TBATInit("tbat_item_veil_of_knowledge_potion","images/inventoryimages/tbat_item_veil_of_knowledge_potion.xml")
        ------------------------------------------------------------------------------------------
        --- 叠堆
