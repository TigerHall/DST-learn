...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_building_cloud_wooden_sign"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_building_cloud_wooden_sign.zip"),
        Asset("ANIM", "anim/tbat_building_cloud_wooden_sign_owners_1.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 文字图层数据
    local all_info_data = {
        [1] = {
            pt = Vector3(0,-270,0),
            build = "tbat_building_cloud_wooden_sign",
            layer = "rest_area",
        },
        [2] = {
            pt = Vector3(0,-275,0),
        ...
        [7] = {
            --- 隐藏款 ： 痴若离
            pt = Vector3(0,-275,0),
            build = "tbat_building_cloud_wooden_sign_owners_1",
            bank = "tbat_building_cloud_wooden_sign_owners_1",
            anim = "crl",
            hidden = true,
        },
    }
...
--- 皮肤API套件
    ...
    for i = 2, #all_info_data, 1 do
        local this_skin_index = "tbat_building_cloud_wooden_sign_"..i
        building_skin_data[this_skin_index] = {
            bank = "tbat_building_cloud_wooden_sign",
            build = "tbat_building_cloud_wooden_sign",
            atlas = "images/inventoryimages/tbat_building_cloud_wooden_sign.xml",
            image = "tbat_building_cloud_wooden_sign",  -- 不需要 .tex
    ...
    for i = 2, 6, 1 do
        TBAT.SKIN:AddForDefaultUnlock("tbat_building_cloud_wooden_sign_"..i)        
    end
...
--- 创建物品
    local function building()
        ...
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_building_cloud_wooden_sign","tbat_building_cloud_wooden_sign")
