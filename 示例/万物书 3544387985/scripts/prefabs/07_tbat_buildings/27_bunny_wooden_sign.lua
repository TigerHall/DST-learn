...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_building_bunny_wooden_sign"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_building_bunny_wooden_sign.zip"),
        Asset("ANIM", "anim/tbat_building_bunny_wooden_sign_sp_info.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 文字图层数据
    local all_info_data = {
        [1] = {
            pt = Vector3(0,-285,0),
            build = "tbat_building_bunny_wooden_sign",
            layer = "theater",
        },
        [2] = {
            pt = Vector3(0,-285,0),
        ...
        [6] = {
            --- 隐藏款 ： 兔兔
            pt = Vector3(0,-275,0),
            build = "tbat_building_bunny_wooden_sign_sp_info",
            bank = "tbat_building_bunny_wooden_sign_sp_info",
            anim = "bunny",
            hidden = true,
        },
        [7] = {
...
--- 皮肤API套件
    ...
    for i = 2, #all_info_data, 1 do
        local this_skin_index = "tbat_building_bunny_wooden_sign_"..i
        building_skin_data[this_skin_index] = {
            bank = "tbat_building_bunny_wooden_sign",
            build = "tbat_building_bunny_wooden_sign",
            atlas = "images/inventoryimages/tbat_building_bunny_wooden_sign.xml",
            image = "tbat_building_bunny_wooden_sign",  -- 不需要 .tex
        ...
        --- 给解锁提示用
            if all_info_data[i].hidden then
                ...
                if TBAT.DEBUGGING then
                    TBAT.SKIN.SKIN_PACK:Pack("tbat_building_bunny_wooden_sign_owners",this_skin_index)
                end
            end
        -----------------------------------------------------------------------------------
    end
    ...
    for i = 2, 5, 1 do
        TBAT.SKIN:AddForDefaultUnlock("tbat_building_bunny_wooden_sign_"..i)        
    end
...
--- 创建物品
    local function building()
        ...
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_building_bunny_wooden_sign","tbat_building_bunny_wooden_sign")
