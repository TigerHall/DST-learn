...
--- 皮肤API套件
    local skins_data = {
        ["tbat_pbt_sweetwhim_stand"] = {                    --- 
            ...
            image = "tbat_building_plum_blossom_table_sweetwhim_stand",  -- 不需要 .tex
            name = TBAT:GetString2(this_prefab,"skin.sweetwhim_stand"),        --- 切名字用的
            name_color = "purple",
            ...
            server_fn = function(inst)
                inst.MiniMapEntity:SetIcon("tbat_building_plum_blossom_table_sweetwhim_stand.tex")
...
--- 创建物品
    local function fn()
        ...
        inst.MiniMapEntity:SetIcon(this_prefab..".tex")
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_building_plum_blossom_table","tbat_building_plum_blossom_table")
        -- inst.AnimState:SetBank("tbat_building_plum_blossom_table")
        -- inst.AnimState:SetBuild("tbat_building_plum_blossom_table")
        inst.AnimState:PlayAnimation("idle",true)
        inst.AnimState:OverrideSymbol("slot","tbat_building_plum_blossom_table","empty")
        inst.AnimState:SetTime(4*math.random())
