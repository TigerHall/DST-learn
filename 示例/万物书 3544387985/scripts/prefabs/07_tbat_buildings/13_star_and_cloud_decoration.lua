...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 前置准备
    local this_prefab = "tbat_building_star_and_cloud_decoration"
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- Assets素材资源
    local assets =
    {
        Asset("ANIM", "anim/tbat_building_star_and_cloud_decoration.zip"),
    }
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--- 皮肤API套件
    ...
    for i = 2, 6, 1 do
        building_skin_data["tbat_building_star_and_cloud_decoration_"..i] = {
            bank = "tbat_building_star_and_cloud_decoration",
            build = "tbat_building_star_and_cloud_decoration",
            atlas = "images/inventoryimages/tbat_building_star_and_cloud_decoration_"..i..".xml",
            image = "tbat_building_star_and_cloud_decoration_"..i,  -- 不需要 .tex
            name = TBAT:GetString2(this_prefab,"skin_"..i),        --- 切名字用的
            name_color = {255/255,255/255,255/255,1},
            type = i,
            placed_skin_name = "tbat_building_star_and_cloud_decoration_kit_"..i,  --- 放置出来的皮肤名字。
            skin_link = "tbat_building_star_and_cloud_decoration_kit_"..i,  --- 放置出来的皮肤名字。
        ...
        item_skin_data["tbat_building_star_and_cloud_decoration_kit_"..i] = {
            bank = "tbat_building_star_and_cloud_decoration",
            build = "tbat_building_star_and_cloud_decoration",
            atlas = "images/inventoryimages/tbat_building_star_and_cloud_decoration_"..i..".xml",
            image = "tbat_building_star_and_cloud_decoration_"..i,  -- 不需要 .tex
            ...
            name_color = {255/255,255/255,255/255,1},
            type = i,
            placed_skin_name = "tbat_building_star_and_cloud_decoration_"..i,  --- 放置出来的皮肤名字。
            skin_link = "tbat_building_star_and_cloud_decoration_"..i,
            server_fn = function(inst) -- 切换到这个skin调用 。服务端
                inst.AnimState:PlayAnimation("type"..i)
            end,
            server_switch_out_fn = function(inst) -- 切换离开这个皮肤用
    ...
    for i = 2, 6, 1 do
        TBAT.SKIN:AddForDefaultUnlock("tbat_building_star_and_cloud_decoration_kit_"..i)        
    end
...
--- 创建物品
    ...
    local function building()
        ...
        TBAT.SKIN:SetDefaultBankBuild(inst,"tbat_building_star_and_cloud_decoration","tbat_building_star_and_cloud_decoration")
...
--- kit
    ...
    local function item_fn()
        ...
        ---
            ...
            inst.components.inventoryitem:TBATInit("tbat_building_star_and_cloud_decoration_1","images/inventoryimages/tbat_building_star_and_cloud_decoration_1.xml")
        --------------------------------------------------------------------
        --- 
