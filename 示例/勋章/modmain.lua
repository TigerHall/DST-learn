...
PrefabFiles = {
	...
	"medal_origin_cactus",--本源仙人掌
	"medal_sporecloud",--本源孢子云
	"medal_origin_fruitfly",--本源果蝇
	"medal_origin_tree_guard",--本源守卫
	"medal_origin_mosquito",--本源血蚊
	"medal_origin_glowfly",--本源飞虫
	"medal_origin_beetle",--本源甲虫
	"medal_origin_flowertrap",--本源恶臭花
	"medal_origin_mushgnome",--本源地精
	"medal_origin_spider",--本源蜘蛛
}
...
Assets =
{
	...
	-- Asset("SOUNDPACKAGE", "sound/dontstarve_DLC003.fev"),--暂时屏蔽,后续挪了再用
	-- Asset("SOUND", "sound/DLC003_sfx.fsb"),--暂时屏蔽,后续挪了再用
}
...
AddMinimapAtlas("minimap/medal_origin_small_tree.xml")
AddMinimapAtlas("minimap/medal_origin_small_tree_stump.xml")
AddMinimapAtlas("minimap/medal_origin_tree.xml")
