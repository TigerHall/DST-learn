...
local function onEat(inst,eater)
	...
	if grogginess ~= nil then 
		--玩家有睡眠免疫buff的话，优先移除
        if eater:HasDebuff("shroomsleepimmunity") then
            eater:RemoveDebuff("shroomsleepimmunity")
        else
	...
	--概率掉落种子
    local mandrake_chance = eater:HasTag("player") and TUNING_MEDAL.MANDRAKEBERRY_SEED_CHANCE.MANDRAKE_CONMON or TUNING_MEDAL.MANDRAKEBERRY_SEED_CHANCE.MANDRAKE_LESS
    ...
    weed_chance = mandrake_chance + weed_chance
    --蔓草种子
