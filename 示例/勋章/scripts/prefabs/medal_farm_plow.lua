...
local function autoDistribution(inst)
	...
	inst:RemoveTag("CanAutoDistribution")--一键分配后移除该标签,方便关闭容器(对于手柄操作来说需要)
end

local function onopen(inst)
    inst:AddTag("CanAutoDistribution")--支持一键分配(对于手柄操作来说需要)
end

local function onclose(inst)
    inst:RemoveTag("CanAutoDistribution")
end
...
local function item_fn()
	...
	inst.autoDistribution = autoDistribution
