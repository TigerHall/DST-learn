local minisign_show_list = {
	...
	"armor_medal_space_time",--时空晶甲
	"medal_origin_essence",--本源精华
	--暗影工具
	"medal_shadow_axe",
	...
	"sanityrock_mace_skin2",--方尖锏(一剑霜寒)
	"sanityrock_mace_skin3",--方尖锏(薯掉了)
	"devour_staff_skin1",--吞噬法杖(贪吃蛇)
	"devour_staff_skin2",--吞噬法杖(爱捞物鱿)
	...
	"medal_krampus_chest_item_skin3",--坎普斯宝匣(堡在我身上,关闭)
	"medal_krampus_chest_item_skin3_open",--坎普斯宝匣(堡在我身上,打开)
	"medal_goathat_skin1",--羊角帽(财运亨通)
	"medal_fishingrod_skin1",--玻璃钓竿(红梅报喜)
	"medal_box_skin1",--勋章盒(金钗钿合,关闭)
	"medal_box_skin1_open",--勋章盒(金钗钿合,打开)
	"medal_box_skin2",--勋章盒(纸上雪,关闭)
	"medal_box_skin2_open",--勋章盒(纸上雪,打开)
	"spices_box_skin1",--调料盒(五味俱全,关闭)
	"spices_box_skin1_open",--调料盒(五味俱全,打开)
	"spices_box_skin2",--调料盒(祈福香囊,关闭)
	"spices_box_skin2_open",--调料盒(祈福香囊,打开)
	"spices_box_skin3",--调料盒(星星糖果罐,关闭)
	"spices_box_skin3_open",--调料盒(星星糖果罐,打开)
	...
	"medal_moonlight_staff_skin1",--月光法杖(Die 蕉布)
	"immortal_staff_skin1",--不朽法杖(汽可朽)
	"hat_blue_crystal_skin1",--蓝晶帽(顶瓜瓜)
}
--勋章
