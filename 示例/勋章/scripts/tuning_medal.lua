...
TUNING_MEDAL ={
	...
	MINER_MEDAL={--矿工勋章
		...
		MEDIUM_MULT = 1.5,--中级挖矿效率
		LARGE_MULT = 3,--高级挖矿效率
		ORIGIN_MULT = 4,--本源高级挖矿效率
	},
	PLANT_MEDAL={--虫木勋章
	...
	OMMATEUM_MEDAL={--复眼勋章
		...
		ADD_MAXTIME_LOOT = {--增加耐久上限
			wormlight = {--发光浆果
				addtime = 20*gain_mult,--单颗可增加耐久上限
				maxtime = total_day_time*5,--最大耐久上限
			},
			ancientfruit_nightvision = {--夜莓
				addtime = 120*gain_mult,--单颗可增加耐久上限
				maxtime = total_day_time*10,--最大耐久上限
			},
		},
		REPAIR_LOOT = {--补充耐久
	...
	--曼德拉果
	MANDRAKE_BERRY_SPAWNER_TIME = 25,--曼德拉果生成时间
	MANDRAKE_BERRY_SPAWNER_TIME_VARIANCE = 10,--曼德拉果生成时间偏差
	...
	MEDAL_BUFF_INJURED_MAX = 10*consume_mult,--层数上限
	--血蜜标记
	...
	--混沌侵蚀
	MEDAL_BUFF_CHAOS_EROSION_DURATION = total_day_time,--8分钟
	MEDAL_BUFF_CHAOS_EROSION_MAX = 5,--混沌侵蚀层数上限
	MEDAL_BUFF_CHAOS_EROSION_MULT = .2,--每层增伤百分比(混沌伤害)
	--本源能量
	MEDAL_BUFF_ORIGIN_ENERGY_DURATION = total_day_time,--8分钟
	MEDAL_BUFF_ORIGIN_ENERGY_MAX = 100,--层数上限
	...
	RAGE_KRAMPUS_SOUL_LIFETIME = 60,--黑暗灵魂存在时间
	RAGE_KRAMPUS_SOUL_DROP_TIME = 3,--黑暗灵魂爆魂周期
	...
	MEDAL_ORIGIN_TREE_SHADE_CANOPY_RANGE = 36,--树冠范围(水中木28)
	MEDAL_ORIGIN_TREE_INSECT_NUM_MAX = 100,--本源昆虫的最大数量上限
	MEDAL_ORIGIN_TREE_INSECT_SPAWNTIME_MAX = {20,16,12,10,5},--本源飞虫生成周期最大值(只有4个阶段,第5条表示第一次生成的周期)
	MEDAL_ORIGIN_TREE_INSECT_SPAWNTIME_MIN = {10,8,6,5,1},--本源飞虫生成周期最小值(只有4个阶段,第5条表示第一次生成的周期)
	MEDAL_ORIGIN_TREE_NEAR_SPAWN_CD = 20,--玩家出范围后隔多久重新进入范围会生成本源之花
	PARASITIC_CONVERSION_RATIO = {0.5,0.6,0.75,0.9},--寄生值转化率(阶段越高转化率越高)
	PARASITIC_CONVERSION_MULT = {1,1.5,2,3},--寄生值转化倍率(每点寄生值可给本源之树的回血量)
	MEDAL_ORIGIN_TREE_SPAWN_CHILD_NUM = {--各个阶段召唤物生成数量
		GUARD = {3,3,4,5},--守卫(总数)
		MUSHGNOME = {2,3,3,4},--地精(单人,多人=单人+总人数)
		SPIDER = {2,3,3,4},--蜘蛛(单人,多人=单人+总人数)
		TRAP = {3,4,5,6},--恶臭花(总数)
	},
	--本源根鞭
	MEDAL_ORIGIN_TREE_ROOT_ATTACK_RADIUS = 3.7,--攻击距离
	MEDAL_ORIGIN_TREE_ROOT_DAMAGE = 30,--伤害
	MEDAL_ORIGIN_TREE_ROOT_CHAOS_DAMAGE = 15,--混沌伤害
	--本源之花
	MEDAL_ORIGIN_FLOWER_SPAWN_NUM = {8,10,12,14},--本源之花生成数量
	MEDAL_ORIGIN_FLOWER_MUTATION_PROB = {0,0.1,0.2,0.3},--本源之花变异概率
	--本源仙人掌
	MEDAL_ORIGIN_CACTUS_HEALTH = 500,--血量
	MEDAL_ORIGIN_CACTUS_RANGE = 5,--攻击范围
	MEDAL_ORIGIN_CACTUS_DAMAGE = 45,--伤害
	MEDAL_ORIGIN_CACTUS_CHAOS_DAMAGE = 15,--混沌伤害
	MEDAL_ORIGIN_CACTUS_REBOUND_DAMAGE = 20,--反伤
	MEDAL_ORIGIN_CACTUS_REGROW_PERIOD = 2,--刺重新长出来的时间
	MEDAL_ORIGIN_CACTUS_CHOP_ABSORB = 0.04,--给本源之树减伤
	--本源仙人掌根
	MEDAL_ORIGIN_CACTUS_STUMP_CHOP_ABSORB = 0.02,--给本源之树减伤
	MEDAL_ORIGIN_CACTUS_STUMP_WORKLEFT = 10,--挖掘次数
	--本源甲虫
	MEDAL_ORIGIN_BEETLE_HEALTH = 300,--血量
	MEDAL_ORIGIN_BEETLE_WALK_SPEED = 5,--移速
	MEDAL_ORIGIN_BEETLE_DAMAGE = 50,--伤害
	MEDAL_ORIGIN_BEETLE_CHAOS_DAMAGE = 15,--混沌伤害
	MEDAL_ORIGIN_BEETLE_PERIOD_MIN = 4,--最小攻击间隔
	MEDAL_ORIGIN_BEETLE_PERIOD_MAX = 5,--最大攻击间隔
	MEDAL_ORIGIN_BEETLE_ATTACK_RANGE = 5,--攻击距离
	MEDAL_ORIGIN_BEETLE_HIT_RANGE = 1.5,--攻击范围
	MEDAL_ORIGIN_BEETLE_MELEE_RANGE = 1.5,--扑击判定距离
	MEDAL_ORIGIN_BEETLE_RUN_AWAY_DIST = 3,--逃跑距离
	MEDAL_ORIGIN_BEETLE_STOP_RUN_AWAY_DIST = 5,--停止逃跑距离
	MEDAL_ORIGIN_BEETLE_TARGET_DIST = 6,--仇恨目标范围
	MEDAL_ORIGIN_BEETLE_SPAWN_TIME = {30,25,20,15},--生成周期
	MEDAL_ORIGIN_BEETLE_MAX_NUM = {2,3,4,4},--人均最大数量
	MEDAL_ORIGIN_BEETLE_SPAWN_NUM = {1,1,2,2},--单次最大生成数量
	--本源飞虫
	MEDAL_ORIGIN_GLOWFLY_HEALTH = 100,--血量
    MEDAL_ORIGIN_GLOWFLY_WALKSPEED = 6,--移速
	MEDAL_ORIGIN_GLOWFLY_WORKLEFT = 10,--捕捉次数
	MEDAL_ORIGIN_GLOWFLY_COCOON_TIME = {90,75,60,45},--存活多久后开始结茧
	MEDAL_ORIGIN_GLOWFLY_COCOON_FAST = 5,--快速结茧时间
	--本源飞虫茧
	MEDAL_ORIGIN_COCOON_HATCH_TIME_MIN = 5,--最小孵化时间
	MEDAL_ORIGIN_COCOON_HATCH_TIME_MAX = 8,--最大孵化时间
    MEDAL_ORIGIN_COCOON_RECOVERY = 20,--给本源之树回血量
	--本源果蝇
	MEDAL_ORIGIN_FRUITFLY_HEALTH = 200,--血量
    MEDAL_ORIGIN_FRUITFLY_DAMAGE = 30,--伤害
	MEDAL_ORIGIN_FRUITFLY_CHAOS_DAMAGE = 15,--混沌伤害
	MEDAL_ORIGIN_FRUITFLY_PARASITIC = 10,--寄生值
    ...
    MEDAL_ORIGIN_MOSQUITO_DAMAGE = 15,--伤害
	MEDAL_ORIGIN_MOSQUITO_CHAOS_DAMAGE = 15,--混沌伤害
	MEDAL_ORIGIN_MOSQUITO_HEALTH_PENALTY = .05,--血上限惩罚
	...
	MEDAL_SPORECLOUD_PARASITIC = 20,--寄生值
	MEDAL_SPORECLOUD_CHAOS_DAMAGE = 15,--混沌伤害
    ...
    MEDAL_ORIGIN_TREE_GUARD_DAMAGE = 120,--伤害
	MEDAL_ORIGIN_TREE_GUARD_CHAOS_DAMAGE = 40,--混沌伤害
	-- MEDAL_ORIGIN_TREE_GUARD_PARASITIC = 100,--寄生值
	MEDAL_ORIGIN_TREE_GUARD_CONFUSION_TIME = 8,--造成混乱的时长
	MEDAL_ORIGIN_TREE_GUARD_RANGE = 12,--仇恨范围
	MEDAL_ORIGIN_TREE_GUARD_GIVEUPRANGE = 22,--放弃仇恨范围
	MEDAL_ORIGIN_TREE_GUARD_VINE_LIMIT = 2,--藤蔓数量上限
	MEDAL_ORIGIN_TREE_GUARD_REST_TIME = 7,--休眠时长
	MEDAL_ORIGIN_TREE_GUARD_WAKE_TIME = 5,--苏醒过程时长
	MEDAL_ORIGIN_TREE_GUARD_ABSORB = 0.15,--给本源之树减伤
	--本源守卫(藤蔓)
	MEDAL_ORIGIN_TREE_GUARD_VINE_HEALTH = 500,--血量
	...
	--本源恶臭花
	MEDAL_ORIGIN_FLOWERTRAP_WORKLEFT = 50,--锤击次数
	MEDAL_ORIGIN_FLOWERTRAP_PANIC_TIME = 10,--恐慌时长
	MEDAL_ORIGIN_FLOWERTRAP_AOERANGE = 3,--攻击范围
	MEDAL_ORIGIN_FLOWERTRAP_GROGGINESS = 1.0,--昏睡值
	MEDAL_ORIGIN_FLOWERTRAP_KNOCKOUTTIME = 3.0,--昏睡时长
	MEDAL_ORIGIN_FLOWERTRAP_CONFUSION_TIME = 8,--造成混乱的时长
	--本源地精
	MEDAL_ORIGIN_MUSHGNOME_HEALTH = 2000,--血量
	MEDAL_ORIGIN_MUSHGNOME_DAMAGE = 30,--伤害
	MEDAL_ORIGIN_MUSHGNOME_CHAOS_DAMAGE = 30,--混沌伤害
	MEDAL_ORIGIN_MUSHGNOME_ATTACK_RANGE= 15,--(发起)攻击范围
	MEDAL_ORIGIN_MUSHGNOME_WALK_SPEED = 3,--移速
	MEDAL_ORIGIN_MUSHGNOME_LEAF_ATTACK_RANGE= 3.5,--发起叶片攻击的范围
	MEDAL_ORIGIN_MUSHGNOME_AOE_RANGE= 3,--AOE攻击范围
	MEDAL_ORIGIN_MUSHGNOME_ATTACK_PERIOD = 6,--攻击间隔
	MEDAL_ORIGIN_MUSHGNOME_SPORESPAWN_MIN = 4,--孢子生成最小时间
	MEDAL_ORIGIN_MUSHGNOME_SPORESPAWN_MAX = 6,--孢子生成最大时间
	--本源地精孢子
	MEDAL_ORIGIN_MUSHGNOME_SPORE_DAMAGE = 15,--伤害
	MEDAL_ORIGIN_MUSHGNOME_SPORE_CHAOS_DAMAGE = 15,--混沌伤害
	MEDAL_ORIGIN_MUSHGNOME_SPORE_PARASITIC = 20,--寄生值
	MEDAL_ORIGIN_MUSHGNOME_SPORE_ATTACK_RANGE = 3,--爆炸伤害范围
	MEDAL_ORIGIN_MUSHGNOME_SPORE_ATTACK_PROXIMITY = 3.5,--开始爆炸的距离
	MEDAL_ORIGIN_MUSHGNOME_SPORE_PERISH_TIME = seg_time * 0.25,--新鲜值
	MEDAL_ORIGIN_MUSHGNOME_SPORE_MAX_DENSITY = 20,--密度(同时能存在的数量)
	MEDAL_ORIGIN_MUSHGNOME_SPORE_MAX_DENSITY_RAD = 20,--密度计算范围
	MEDAL_ORIGIN_MUSHGNOME_SPORE_DENSITY_CHECK_TIME = 15,--密度检测周期(基础时间)
	MEDAL_ORIGIN_MUSHGNOME_SPORE_DENSITY_CHECK_VAR = 15,--密度检测周期(增值)
	--本源蜘蛛
	MEDAL_ORIGIN_SPIDER_HEALTH = 2000,--血量
	MEDAL_ORIGIN_SPIDER_DAMAGE = 60,--伤害
	MEDAL_ORIGIN_SPIDER_CHAOS_DAMAGE = 30,--混沌伤害
	MEDAL_ORIGIN_SPIDER_ATTACK_PERIOD = 3,--攻击间隔
	MEDAL_ORIGIN_SPIDER_ATTACK_RANGE = 6,--攻击距离
	MEDAL_ORIGIN_SPIDER_HIT_RANGE = 3,--攻击范围
	MEDAL_ORIGIN_SPIDER_MELEE_RANGE = 3,--扑击判定距离
	MEDAL_ORIGIN_SPIDER_TARGET_DIST = 10,--仇恨距离
	MEDAL_ORIGIN_SPIDER_WALK_SPEED = 4,--行走速度
    MEDAL_ORIGIN_SPIDER_RUN_SPEED = 5,--跑步速度
	MEDAL_ORIGIN_SPIDER_AGGRESSIVE_MAX_CHASE_TIME = 8,--最大追击时间
