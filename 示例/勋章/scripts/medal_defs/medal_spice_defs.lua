...
local medal_spices = {
	spice_jelly={--果冻粉
		...
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_moistureimmunity")--添加干燥buff
		end
	},
	spice_voltjelly={--带电果冻粉
		prefabs = {"buff_electricattack"},
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_electricattack")--添加电击buff
		end
	},
	spice_phosphor={--荧光粉
	...
	spice_moontree_blossom={--月树花粉
		...
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_sanityregen")--添加精神保护buff
		end
	},
	spice_cactus_flower={--仙人掌花粉
		prefabs = {"buff_medal_quicklocomotor"},
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_quicklocomotor")--添加加速buff
		end
	},
	spice_blood_sugar={--血糖
		prefabs = {"buff_medal_bloodsucking"},
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_bloodsucking")--添加凝血buff(掉血减半)
		end
	},
	spice_rage_blood_sugar={--黑暗血糖
		prefabs = {"buff_medal_suckingblood"},
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_suckingblood")--添加吸血buff
		end
	},
	spice_soul={--灵魂佐料
		-- prefabs = {"wormlight_light_greater"},
	...
	spice_potato_starch={--土豆淀粉
		...
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_assuagehunger")--添加饱腹buff
		end
	},
	spice_poop={--秘制酱料
		...
		oneatenfn=function(inst, eater)
		    ...
		    if eater.prefab=="wormwood" then
				...
				eater:AddMedalDebuff("buff_medal_poopfood")--添加吃屎buff
		    --其他人吃了扣san
	...
	spice_plantmeat={--叶肉酱
		...
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_upappetite")--添加开胃buff
			--降一定的饱食度
	...
	spice_mandrake_jam={--曼德拉果酱
		...
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_nostiff")--添加霸体buff(免疫被打击时的僵直)
		end
	},
	spice_pomegranate={--山力叶酱(石榴)
		prefabs = {"buff_medal_strong"},
		oneatenfn=function(inst, eater)
			eater:AddMedalDebuff("buff_medal_strong")--添加强壮buff(搬运重物不减速)
		end
	},
	spice_withered_royal_jelly={--凋零蜂王浆酱
		...
		oneatenfn=function(inst, eater)
			...
			if eater.medal_aoecombat then
				...
				eater:AddMedalDebuff("buff_medal_aoecombat")--aoe范围伤害
			end
		end
	},
}
