...
local Recipes = {
	...
	--本源精华
    {
        ...
        ingredients = {
            {
				MedalIngredient("medal_shadow_magic_stone", 0), MedalIngredient("medal_dustmeringue", 3), MedalIngredient("spice_withered_royal_jelly", 3), MedalIngredient("spice_rage_blood_sugar", 3),
			},
        },
        level = TECH.NONE,
		builder_tag = "traditionalbearer3",
...
local DeconstructRecipes = {
	...
	--本源勋章
	{
        ...
        ingredients = {
            Ingredient("large_multivariate_certificate", 2),
        },
    },
}
