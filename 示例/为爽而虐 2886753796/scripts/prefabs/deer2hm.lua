...
local function PiercingDamage(inst, target, damage, weapon)
    return (target.components.health ~= nil and target.components.health.currenthealth * 0.1) or 0
end
...
local function common_fn(gem)
    ...
    inst.displaynamefn = function() 
        return (TUNING.isCh2hm and "无眼鹿") or "No-Eyed Deer"
    end
...
return Prefab("deer_red2hm", redfn, assets, redprefabs),
    Prefab("deer_blue2hm", bluefn, assets, blueprefabs)
