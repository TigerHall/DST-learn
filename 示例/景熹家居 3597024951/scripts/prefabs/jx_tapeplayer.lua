local assets =
{
    Asset("ANIM", "anim/jx_tapeplayer.zip"),

    Asset("SOUNDPACKAGE", "sound/jx_tape.fev"),
    Asset("SOUND", "sound/jx_tape.fsb"),
}
...
local function GetRecordSong(inst)
    return "jx_tape/jx_tape/jx_tape"
end
...
local function fn()
    ...
    inst.AnimState:SetBank("jx_tapeplayer")
    inst.AnimState:SetBuild("jx_tapeplayer")
...
return Prefab("jx_tapeplayer", fn, assets, prefabs)
