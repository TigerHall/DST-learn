...
local FLOATABLE_SWAP_DATA = { bank = "jx_basket", anim = "closed" }
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("jx_basket.tex")

    inst.AnimState:SetBank("jx_basket")
    inst.AnimState:SetBuild("jx_basket")
    ...
    inst.components.container:WidgetSetup("jx_basket")
    ...
    inst:AddComponent("preserver")
	  inst.components.preserver:SetPerishRateMultiplier(.85)
...
return Prefab("jx_basket", fn, assets, prefabs)