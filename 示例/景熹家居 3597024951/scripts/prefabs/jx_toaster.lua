local assets =
{
    Asset("ANIM", "anim/jx_toaster.zip"),
    Asset("ATLAS", "images/inventoryimages/jx_toaster1.xml"),
    Asset("IMAGE", "images/inventoryimages/jx_toaster1.tex"),
    Asset("ATLAS", "images/inventoryimages/jx_toaster2.xml"),
    Asset("IMAGE", "images/inventoryimages/jx_toaster2.tex"),
    Asset("ATLAS", "images/inventoryimages/jx_toaster3.xml"),
    Asset("IMAGE", "images/inventoryimages/jx_toaster3.tex"),
    Asset("ATLAS", "images/inventoryimages/jx_toaster4.xml"),
    Asset("IMAGE", "images/inventoryimages/jx_toaster4.tex"),
    Asset("ATLAS", "images/inventoryimages/jx_toaster5.xml"),
    Asset("IMAGE", "images/inventoryimages/jx_toaster5.tex"),
}
...
local function OnRemove(inst)
    inst._light:Remove()
    if IsSteam() then
        inst._JBK_DEBUG_TRACE = _TRACEBACK()
    end
end
...
local function UpdateImages(inst, range)
    ...
    inst.components.inventoryitem.imagename = "jx_toaster"..tostring(range)
    inst.components.inventoryitem.atlasname = "images/inventoryimages/jx_toaster"..tostring(range)..".xml"
    if range == 5 then
...
local function fn()
    ...
    inst.AnimState:SetBank("jx_toaster")
    inst.AnimState:SetBuild("jx_toaster")
...
return Prefab("jx_toaster", fn, assets)