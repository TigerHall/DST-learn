...
configuration_options = L and {
    ...
    {   name = "ShyCoreGrowth",
        label = "Treembling Heart Growth Rate",
        hover = "Set the accumulation speed of the growth point of the Treembling Heart.",
        options = {
            {description = "50%", data = 0.5},
    ...
    {   name = "ShyCoreFruits",
        label = "Treembling Heart Fruiting Speed",
        hover = "Set the accumulation speed of the fruit point of the Treembling Heart.",
        options = {
            {description = "50%", data = 0.5},
            {description = "75%", data = 0.75},
            {description = "90%", data = 0.9},
    ...
    {   name = "SoulBookHealMult",
        label = "Healing Mult of Soul Contracts",
        hover = "Set the healing multiplier of Soul Contracts.",
        options = {
            {description = "No Healing", data = 0.0},
            {description = "0.1x", data = 0.1},
            {description = "0.25x", data = 0.25},
            {description = "0.5x", data = 0.5},
            {description = "0.75x", data = 0.75},
            {description = "0.9x", data = 0.9},
            {description = "1x(default)", data = 1.0},
            {description = "1.1x", data = 1.1},
            {description = "1.25x", data = 1.25},
            {description = "1.5x", data = 1.5},
            {description = "2x", data = 2.0},
            {description = "3x", data = 3.0},
            {description = "4x", data = 4.0}
        },
        default = 1.0
    },
    ...
    {   name = "HiddenUpdateTimes",
        label = "Max Upgrade Times of MoonHidden",
        hover = "Set the maximum upgrade times of MoonHidden (the smaller, the easier).",
        options = {
            ...
            { description = "100 times", data = 100 }
        },
        default = 20
    },
    {   name = "SimmerUpdateTimes",
        label = "Max Upgrade Times of MoonSimmered",
        hover = "Set the maximum upgrade times of MoonSimmered (the smaller, the easier).",
        options = {
            { description = "1 times", data = 1 },
            { description = "5 times", data = 5 },
            { description = "8 times", data = 8 },
    ...
    {   name = "RevolvedUpdateTimes",
        label = "Max Upgrade Times of MoonRevolved",
        hover = "Set the maximum upgrade times of MoonRevolved (the smaller, the easier).",
        options = {
    ...
    {   name = "RefractedUpdateTimes",
        label = "Max Upgrade Times of MoonRefracted",
        hover = "Set the maximum upgrade times of MoonRefracted (the smaller, the easier).",
        options = {
    ...
    {   name = "WorldSwordLimitation",
        label = "World Swords to Other Worlds",
        hover = "Set whether to allow MoonRefracted and Agron's Sword to be directly taken to other worlds.",
        options = {
            {description = "Allow", data = true},
            {description = "Prohibit(default)", data = false}
        },
        default = false
    },
    ...
    {   name = "BetterCookBook",
        label = "优化食谱介绍",
        hover = "优化食谱的介绍界面和信息展示（仅支持中文环境）。美味在细节中！",
        options = {
    ...
    {   name = "ShyCoreGrowth",
        label = "颤栗树之心生长速度",
        hover = "设置颤栗树之心的生长点的积累速度。长快快！",
        options = {
            {description = "50%", data = 0.5},
            {description = "75%", data = 0.75},
            {description = "90%", data = 0.9},
            {description = "100%(默认)", data = 1},
            {description = "110%", data = 1.1},
            {description = "125%", data = 1.25},
            {description = "150%", data = 1.5},
            {description = "200%", data = 2},
    ...
    {   name = "SoulBookHealMult",
        label = "灵魂契约的回血系数",
        hover = "设置灵魂契约的回血系数。无数次思考后的治愈。",
        options = {
            {description = "不回血", data = 0.0},
            {description = "0.1倍", data = 0.1},
            {description = "0.25倍", data = 0.25},
            {description = "0.5倍", data = 0.5},
            {description = "0.75倍", data = 0.75},
            {description = "0.9倍", data = 0.9},
            {description = "1倍(默认)", data = 1.0},
            {description = "1.1倍", data = 1.1},
            {description = "1.25倍", data = 1.25},
            {description = "1.5倍", data = 1.5},
            {description = "2倍", data = 2.0},
            {description = "3倍", data = 3.0},
            {description = "4倍", data = 4.0}
        },
        default = 1.0
    },
    ...
    {   name = "WorldSwordLimitation",
        label = "世界之剑能否带到其他世界",
        hover = "设置月折宝剑、艾力冈的剑是否能被直接带到其他世界。若允许，该武器会有被摧毁的风险。",
        options = {
            {description = "允许", data = true},
            {description = "禁止(默认)", data = false}
        },
        default = false
    },
