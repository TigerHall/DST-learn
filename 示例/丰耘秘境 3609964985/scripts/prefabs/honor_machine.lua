local assets =
{
    Asset("ANIM", "anim/honor_machine.zip"),
}
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("honor_machine.tex")

    inst.AnimState:SetBank("honor_machine")
    inst.AnimState:SetBuild("honor_machine")
    ...
    inst.components.prototyper.trees = TUNING.PROTOTYPER_TREES.HONOR_TECH
...
return Prefab("honor_machine", fn, assets),
       MakePlacer("honor_machine_placer", "honor_machine", "honor_machine", "idle")