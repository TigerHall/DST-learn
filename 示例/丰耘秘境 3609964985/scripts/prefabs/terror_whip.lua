local assets =
{
    Asset("ANIM", "anim/terror_whip.zip"),
    Asset("ANIM", "anim/swap_terror_whip.zip"),
    Asset("ATLAS", "images/inventoryimages/terror_whip.xml"),
    Asset("IMAGE", "images/inventoryimages/terror_whip.tex"),
}

local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_terror_whip", "swap_whip")
    owner.AnimState:OverrideSymbol("whipline", "swap_terror_whip", "whipline")
...
local function fn()
    ...
    inst.AnimState:SetBank("terror_whip")
    inst.AnimState:SetBuild("terror_whip")
    ...
    inst.components.inventoryitem.imagename = "terror_whip"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/terror_whip.xml"
...
return Prefab("terror_whip", fn, assets)