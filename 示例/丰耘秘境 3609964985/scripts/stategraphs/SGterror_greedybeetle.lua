...
{
    ActionHandler(ACTIONS.HEATPLANT, "plant_attack"),
}
...
local states=
{
    ...
    State{
		...
		timeline =
		{
			...
			TimeEvent(37 * 3 * FRAMES, function(inst)
				inst:PerformBufferedAction()
...
return StateGraph("terror_greedybeetle", states, events, "taunt", actionhandlers)