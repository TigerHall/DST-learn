...
local config = require("hmrmain/hmr_config_data")

local ModConfigurationScreen = Class(Widget, function(self, modname, client_config)
	Widget._ctor(self, "ModConfigurationScreen")
    ...
    -- title:SetTruncatedString("丰耘秘境", title_max_w - title_suffix_w, title_max_chars - 1 - STRINGS.UI.MODSSCREEN.CONFIGSCREENTITLESUFFIX:len(), true)
...
function ModConfigurationScreen:MapControl(deviceId, controlId, controlName)
