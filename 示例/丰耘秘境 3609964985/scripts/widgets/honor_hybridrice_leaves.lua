...
local HybridRiceLeaves = Class(Widget, function(self, owner)
    self.owner = owner
    Widget._ctor(self, "HybridRiceLeaves")
...
function HybridRiceLeaves:OnUpdate(dt)
    ...
    self.under_leaves = self.owner.net_under_hybridrice and self.owner.net_under_hybridrice:value()
