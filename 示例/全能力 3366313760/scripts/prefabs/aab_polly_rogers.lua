...
local brain = require("brains/aab_polly_rogersbrain")

local function Setup(inst, leader)
    inst.leader:set(leader)
end
...
local function fn()
    ...
    inst:SetPrefabNameOverride("polly_rogers")
    ...
    inst.leader = net_entity(inst.GUID, "aab_polly_rogers.leader")
...
return Prefab("aab_polly_rogers", fn, assets)
